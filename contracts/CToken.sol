 ...
 * @author Compound
 */
abstract contract CToken is CTokenInterface, ExponentialNoError {
    /**
    ...
    function transferTokens(address spender, address src, address dst, uint tokens) internal { // returns (bool) {
        /* Fail if transfer not allowed */ /// TODO Not needed since anywhere along the way a failure would revert now
        // uint allowed = comptroller.transferAllowed(address(this), src, dst, tokens);
        // if (allowed != 0) {
        //     revert TransferComptrollerRejection();
        // }
    ...
    function accrueInterest() virtual override public { // returns (uint) {
        ...
        if (accrualBlockNumberPrior == currentBlockNumber) {
            /// TODO How can we halt operations here without returning a NO_ERROR?
            //return NO_ERROR;
        }
    ...
    function mintFresh(address minter, uint mintAmount) internal {
        ...
        // if (allowed != 0) {
        //     revert MintComptrollerRejection();
        // }
    ...
    function redeemFresh(address payable redeemer, uint redeemTokensIn, uint redeemAmountIn) internal {
        ...
        /* Fail if redeem not allowed */ /// TODO Check not needed; would revert along the way
